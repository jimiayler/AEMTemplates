...
rc("ad_status.js",a);Xd.push(Wd(function(){Yd||"google_ad_status"in window||(yc("ad_status.js",a),$b("DCLKSTAT",3))},5E3))}
...
rq;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();G("PL_ATT")&&(zc=null);for(var a=0,b=Xd.length;a<b;a++){var c=Xd[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):I(c)}}Xd.length=0;a=vc("ad_status.js");if(b=document.getElementById(a))qc(a),b.parentNode.removeChild(b);Yd=!1;$b("DCLKSTAT",0);nc(Zp);Zp.length=0;rh($p);$p.length=0;Yp=!1;fp&&(fp.removeEventListener("SUBSCRIBE",jp),fp.removeEventListener("UNSUBSCRIBE",lp));fp=null;rh(gp);gp.length=0;
